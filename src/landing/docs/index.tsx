  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-xl text-slate-600 mb-12 text-center">Learn how to use BetterPush to manage your deployments</p>
          ...
          <section className="mt-16">
            <div className="relative overflow-hidden rounded-2xl border-2 border-slate-200 p-12 text-center">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-slate-600 mb-6 max-w-2xl mx-auto">We're working hard to bring you comprehensive documentation, best practices, and advanced guides. Check back soon!</p>

                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <Link to="/contact" className="px-6 py-3 font-medium rounded-lg transition-all hover:shadow-lg hover:scale-105 text-white" style={{ backgroundImage: "linear-gradient(135deg, rgb(255, 178, 36), rgb(255, 195, 100))" }}>
                    Contact Us
                  </Link>
                </div>
              </div>
